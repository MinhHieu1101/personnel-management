...
const Authentication = () => {
  ...
  return (
    <>
      <div className="sm:h-[75%] h-[60%] landscape:md:h-[60%] landscape:lg:h-[75%] w-5/6 -mt-36 landscape:md:-mt-32 landscape:lg:-mt-40 bg-white dark:bg-slate-900 relative overflow-hidden rounded-lg">
        <div
          id="signin"
